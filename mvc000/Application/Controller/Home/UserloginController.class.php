...
class UserloginController extends \Framework\Controller{
    public function index(){
        ...
        require 'Application/View/Home/Userlogin/Userlogin.html';
    }
    ...
    public function checklogin(){
        ...
        if($data['captcha'] != $_SESSION['captcha']){
            T::jump('验证码错误','Index.php?p=Home&c=Userlogin&a=Index');
        }
        ...
        if(is_array($r)){
            ...
            T::jump('登陆成功！','Index.php?p=Home&a=index&c=Userlist');
        }elseif(is_null($r)) {
            T::jump('用户名或密码有误，请检查以后再提交','Index.php?p=Home&c=Userlogin&a=Index');
        }else{
            T::jump($this->model->err,'Index.php?p=Home&c=Userlogin&a=Index');
        }
    }
    ...
    public function logout(){
        ...
        T::jump('退出成功！','Index.php?p=Home&a=Index&c=Home');
    }
